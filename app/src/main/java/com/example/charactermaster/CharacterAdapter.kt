...
class CharacterAdapter(private val context: GrimoireActivity, private val characters: ArrayList<Character>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.charRace.text = "Раса: " + characters.get(position).race
        holder.charClass.text = "Класс: " + characters.get(position).charClass
        holder.charLevel.text = "Уровень: " + characters.get(position).level.toString()
